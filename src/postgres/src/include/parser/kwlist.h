...
PG_KEYWORD("colocated", COLOCATED, UNRESERVED_KEYWORD)
PG_KEYWORD("colocation", COLOCATION, UNRESERVED_KEYWORD)
...
PG_KEYWORD("failed", FAILED, UNRESERVED_KEYWORD)
...
PG_KEYWORD("nonconcurrently", NONCONCURRENTLY, TYPE_FUNC_NAME_KEYWORD)
...
PG_KEYWORD("tablegroup", TABLEGROUP, UNRESERVED_KEYWORD)
PG_KEYWORD("tablegroups", TABLEGROUPS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("tablets", TABLETS, UNRESERVED_KEYWORD)
