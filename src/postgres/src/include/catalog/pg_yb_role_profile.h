 ...
 * ----------------
 */
CATALOG(pg_yb_role_profile,8052,YbRoleProfileRelationId) BKI_SHARED_RELATION BKI_WITHOUT_OIDS BKI_ROWTYPE_OID(8054,YbRoleProfileRelation_Rowtype_Id) BKI_SCHEMA_MACRO
{
